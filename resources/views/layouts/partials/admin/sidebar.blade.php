...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ route('contact-form-submissions.index') }}" class="nav-link {{ setActive('contact-form-submissions.*') }}">
                    <span class="nav-icon svg-icon svg-baseline">
            ...
            <li class="nav-item has-treeview @if(Request::routeIs('settings.*')) menu-open @endif">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('settings.general.index') }}" class="nav-link {{ setActive('settings.general.index') }}">
                            <i class="far fa-circle nav-icon text-indigo"></i>
                            <p>General</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('settings.api-and-keys.index') }}" class="nav-link {{ setActive('settings.api-and-keys.index') }}">
                            <i class="far fa-circle nav-icon text-danger"></i>
                            <p>API & Keys</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('settings.email.index') }}" class="nav-link {{ setActive('settings.email.index') }}">
                            <i class="far fa-circle nav-icon text-success"></i>
                            <p>Email Settings</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('settings.payment.index') }}" class="nav-link {{ setActive('settings.payment.index') }}">
                            <i class="far fa-circle nav-icon text-warning"></i>
                            <p>Payment Settings</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('settings.image-sliders.index') }}" class="nav-link {{ setActive('settings.image-sliders.index') }}">
                            <i class="far fa-circle nav-icon text-indigo"></i>
                            <p>Image Slider</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('settings.footer.index') }}" class="nav-link {{ setActive('settings.footer.index') }}">
