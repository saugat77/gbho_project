<div class="flex flex-col space-y-4 px-5 my-4">
    <a class="border-3 border-gray-900 text-900 text-center text-lg font-bold py-2 px-4 rounded-full hover:shadow-lg" href="{{ route('login.social', 'facebook') }}">
        <span class="flex items-center flex-wrap">
            <span class="icon">
                <svg class="h-6 fill-parent" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96.124 96.123" style="enable-background:new 0 0 96.124 96.123;" xml:space="preserve">
                    <g>
    ...
    <a class="border-3 border-gray-900 text-900 text-center text-lg font-bold py-2 px-3 rounded-full hover:shadow-lg" href="{{ route('login.social', 'google') }}">
        <span class="flex items-center flex-wrap">
            <span class="icon">
                <svg class="h-6 fill-parent" viewBox="0 0 256 262" xmlns="http://www.w3.org/2000/svg">
