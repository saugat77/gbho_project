...
<nav class="hidden md:block text-dark">
    <div class="container text-sm font-semibold tracking-wider">
        <ul class="flex border-b-2 border-primary divide-x">
                ...
                <div class="px-3 block">
                    <div class="py-2 px-3 pl-0">
                        <span class="flex items-center">
                            ...
                            <span class="uppercase">Browse Categories</span>
                        </span>
                    </div>
                </div>
            ...
            <li class="px-5">
                <a class="inline-block py-2 px-3 hover:text-primary border-b border-transparent hover:border-theme-red " href="{{ route('frontend.products.index') }}">Shop</a>
            </li>
            <li class="px-5">
                <a class="inline-block py-2 px-3 hover:text-primary border-b border-transparent hover:border-theme-red " href="{{ route('frontend.blogs.index') }}">Blogs</a>
            </li>
            <li class="px-5">
                <a class="inline-block py-2 px-3 hover:text-primary border-b border-transparent hover:border-theme-red " href="{{ route('frontend.pages.show', 'about-us') }}">About Us</a>
            </li>
            <li class="px-5">
